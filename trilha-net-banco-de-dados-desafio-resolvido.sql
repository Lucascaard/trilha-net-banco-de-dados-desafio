...
ORDER BY
	QtdeFilme DESC
-- Não é possivel ordernar pela duração pois ela não esta na descrita na clausula GROUP BY. Se for mencionada a duracao
-- no GROUP BY atrapalha o agrupamento por Ano dos Filmes.
